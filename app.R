...
mapStates[['happy_song']]<- rep(NA, length(mapStates[['names']]))
mapStates[['happy_link']]<- rep(NA, length(mapStates[['names']]))

mapStates[['cry_song']]<- rep(NA, length(mapStates[['names']]))
...
for (  i in 1:nrow(song_data)  ){
  mapStates[['happy_song']][which(mapStates[['names']] == song_data[["region"]][i])] <- song_data[["happy_song"]][i]
  
  mapStates[['happy_link']][which(mapStates[['names']] == song_data[["region"]][i])] <- song_data[["happy_link"]][i]
 
  mapStates[['cry_song']][which(mapStates[['names']] == song_data[["region"]][i])] <- song_data[["cry_song"]][i]
